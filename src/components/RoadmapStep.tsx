//src\components\RoadmapStep.tsx
...
export function RoadmapStep({
  ...
  const isExpanded =
    variant === "expanded" || variant === "expanded-with-resources";
  ...
  return (
    ...
    >
      ...
      <Card
        ...
        style={{
          backgroundColor: isSelected ? "#2B2B2B" : statusStyling.background,
        }}
        onClick={onClick}
      >
        <CardHeader className="pb-3">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
            <div className="flex items-start gap-3 flex-1">
              <div
                className={`w-10 h-10 rounded-full bg-gradient-to-br ${getLevelColor(
                  level,
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-2 flex-wrap">
                  <Badge
                    className={`${getLevelBadgeColor(level)} border text-xs`}
                  >
                    {level}
                  </Badge>
                  {initialStatus === "done" && (
                ...
                <div className="md:hidden mt-3 mb-2">
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleStatusChange(
                        value as "not-started" | "in-progress" | "done",
                      )
                    }
                  >
                    <SelectTrigger
                    ...
                    <SelectContent className="bg-[#2B2B2B] border-[#3D3D3D]">
                      <SelectItem
                        value="not-started"
                        className="text-gray-400 focus:bg-[#333333] focus:text-gray-300 text-xs"
                      >
                      ...
                      <SelectItem
                        value="in-progress"
                        className="text-blue-400 focus:bg-[#333333] focus:text-blue-300 text-xs"
                      >
                        <div className="flex items-center gap-2">
                      ...
                      <SelectItem
                        value="done"
                        className="text-emerald-400 focus:bg-[#333333] focus:text-emerald-300 text-xs"
                      >
                        <div className="flex items-center gap-2">
                ...
                <div
                  className="flex items-center gap-3 mt-2 text-sm text-[#b4b4b4]"
                  style={{ fontWeight: 500 }}
                >
              ...
              <div className="hidden md:block">
                ...
                >
                  ...
                  <SelectContent className="bg-[#2B2B2B] border-[#3D3D3D]">
                    <SelectItem
                      value="not-started"
                      className="text-gray-400 focus:bg-[#333333] focus:text-gray-300"
                    >
                      <div className="flex items-center gap-2">
                    ...
                    <SelectItem
                      value="in-progress"
                      className="text-blue-400 focus:bg-[#333333] focus:text-blue-300"
                    >
                      <div className="flex items-center gap-2">
                    ...
                    <SelectItem
                      value="done"
                      className="text-emerald-400 focus:bg-[#333333] focus:text-emerald-300"
                    >
                      <div className="flex items-center gap-2">
        ...
        {isExpanded && (
          <CardContent className="border-t border-[#333333] pt-4">
            <div className="space-y-3">
              <h4
                className="text-[#ffffff] text-sm flex items-center gap-2"
                style={{ fontWeight: 600 }}
              >
              ...
              <p className="text-sm text-[#b4b4b4]" style={{ fontWeight: 500 }}>
                This milestone will take approximately {duration} to complete.
                Click on this node to see detailed resources and mentor tips in
                the right panel.
              </p>
              <Button
                size="sm"
              ...
              {showResourcesPlaceholder && (
                <div className="mt-3 bg-[#232323] border border-[#2E2E2E] rounded-xl p-4 transition-all duration-300">
                  <p
                    className="text-[#ffffff] text-sm mb-1"
                    style={{ fontWeight: 600 }}
                  >
                    Resources will appear here.
                  </p>
                  <p
                    className="text-[#BFBFBF] text-xs"
                    style={{ fontWeight: 500 }}
                  >
