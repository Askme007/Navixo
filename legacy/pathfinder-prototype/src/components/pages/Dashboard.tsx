        ...
        <div className="container mx-auto px-4 md:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <span
                className="hidden sm:inline text-sm text-[#BFBFBF]"
            ...
            <div className="flex items-center gap-2 md:gap-4">
              <span
                className="hidden md:inline text-sm text-[#F5F5F5]"
                style={{ fontWeight: 500 }}
              >
                Welcome, {userName}
              </span>
              ...
              <div className="bg-[#232323] border border-[#3A3A3A] rounded-xl p-4 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="text-center py-4">
                    ...
                    <p
                      className="text-xs text-[#AFAFAF] mb-2"
                      style={{ fontWeight: 500 }}
                    >
                      No activity yet
                    </p>
            ...
            <section className="lg:col-span-6 space-y-6">
              ...
              <div className="bg-[#232323] border border-[#3A3A3A] rounded-xl p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-[#2B2B2B] border border-[#3A3A3A] rounded-lg">
                    <p
                      className="text-xs text-[#AFAFAF] mb-1"
                      style={{ fontWeight: 500 }}
                    >
                      Your Current Focus
                    </p>
                    <p
                      ...
                      style={{ fontWeight: 500 }}
                    >
                      Set by AI after first consultation
                    </p>
                  </div>
                  ...
                  <div
                    className="flex items-center justify-between text-xs text-[#808080]"
                    style={{ fontWeight: 500 }}
                  >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p
                        ...
                        style={{ fontWeight: 500 }}
                      >
                        Discovering interests and opportunities
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                ...
                <div className="h-48 flex items-center justify-center border border-[#3A3A3A] rounded-lg bg-[#1C1C1C]">
                  <div className="text-center">
                    ...
                    <p
                      ...
                      style={{ fontWeight: 500 }}
                    >
                      AI will populate with career data
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <p
                    className="text-xs text-[#AFAFAF] leading-relaxed"
                    style={{ fontWeight: 500 }}
                  >
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-[#2B2B2B] border border-[#3A3A3A] rounded-lg">
                    ...
                    <p
                      ...
                      style={{ fontWeight: 500 }}
                    >
                      AI will suggest personalized actions based on your profile
                      and goals
                    </p>
                    <span
                      className="inline-block mt-2 px-2 py-1 bg-purple-500/10 border border-purple-500/30 rounded text-[10px] text-purple-400"
                      style={{ fontWeight: 500 }}
                    >
                      Dynamic
                    </span>
                  ...
                  <div className="p-3 bg-[#2B2B2B] border border-[#3A3A3A] rounded-lg">
                    ...
                    <p
                      ...
                      style={{ fontWeight: 500 }}
                    >
                      Analysis of your capabilities and areas for growth in your
                      field
                    </p>
                    <span
                      className="inline-block mt-2 px-2 py-1 bg-yellow-500/10 border border-yellow-500/30 rounded text-[10px] text-yellow-400"
                      style={{ fontWeight: 500 }}
                    >
                      AI-Generated
                    </span>
                  ...
                  <div className="p-3 bg-[#2B2B2B] border border-[#3A3A3A] rounded-lg">
                    ...
                    <span
                      className="inline-block mt-2 px-2 py-1 bg-green-500/10 border border-green-500/30 rounded text-[10px] text-green-400"
                      style={{ fontWeight: 500 }}
                    >
                      Live Data
                    </span>
                  ...
                  <div className="p-3 bg-[#2B2B2B] border border-[#3A3A3A] rounded-lg">
                    ...
                    <p
                      ...
                      style={{ fontWeight: 500 }}
                    >
                      Complete evaluations to unlock detailed roadmaps for your
                      career
                    </p>
                    <span
                      className="inline-block mt-2 px-2 py-1 bg-orange-500/10 border border-orange-500/30 rounded text-[10px] text-orange-400"
                      style={{ fontWeight: 500 }}
                    >
                      Action
                    </span>
              ...
              <div className="bg-[#232323] border border-[#3A3A3A] rounded-xl p-4 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="text-center py-4">
                    ...
                    <p
                      className="text-xs text-[#808080] mb-4"
                      style={{ fontWeight: 500 }}
                    >
