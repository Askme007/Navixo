        ...
        {lines.map((line, index) => {
          ...
          if (line.startsWith("## ")) {
            return (
              <h2
                key={index}
                className="text-xl text-white font-semibold mt-6 mb-3 first:mt-0"
              >
                {line.replace("## ", "")}
              </h2>
            );
          ...
          if (line.startsWith("### ")) {
            return (
              <h3
                key={index}
                className="text-lg text-white font-medium mt-5 mb-2"
              >
                {line.replace("### ", "")}
              </h3>
            );
          ...
          if (line.startsWith("# ")) {
            return (
              <h1
                key={index}
                className="text-2xl text-white font-bold mt-6 mb-4 first:mt-0"
              >
                {line.replace("# ", "")}
              </h1>
            );
          ...
          if (line.startsWith("- ")) {
            ...
            return (
              <div key={index} className="flex gap-3 ml-2">
                ...
                <span
                  className="text-[#F5F5F5] flex-1 font-medium"
          ...
          if (line.startsWith("> ")) {
            return (
              <div
                key={index}
                className="border-l-2 border-blue-500 pl-4 py-2 my-3 bg-blue-500/5"
              >
                <p
                  className="text-[#F5F5F5] italic font-medium"
                  style={{ lineHeight: "1.6" }}
                >
                  {line.replace("> ", "")}
                </p>
              ...
              {messages.map((message, index) => {
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      marginTop: shouldAddLargeGap ? "20px" : undefined,
                    }}
                  >
